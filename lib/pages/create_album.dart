...
class CrearAlbum extends StatefulWidget {
  const CrearAlbum({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
                       ...
                       child: Container(
                         ...
                         child: Column(
                          ...
                          children: [
                            ...
                            Image.asset('assets/persona1.jpg',),
                            Text('\u{2795} Añadir Portada',style: TextStyle(
                               color:  Colors.black,
                               fontSize: 25,
                            ),
                            ),
            ...
            TextField(
              ...
              decoration: const InputDecoration(label: Text('Nombre del Album')),
            ),
            const SizedBox(height: 20),
            TextField(
